 ...
 */
public abstract class PowerVmAllocationPolicyMigrationAbstract_MU extends PowerVmAllocationPolicyAbstract {
     ...
     */
    public PowerVmAllocationPolicyMigrationAbstract_MU(
    ...
    public PowerHost findHostForVm(Vm vm, Set<? extends Host> excludedHosts) {
        ...
        for (PowerHost host : this.<PowerHost> getHostList()) {
            ...
            if (host.isSuitableForVm(vm)) {
                ...
                double hostUtilization = host.getUtilizationMips();
                if (maxUtilization < hostUtilization) {
                    maxUtilization = hostUtilization;
                    allocatedHost = host;
                }
            }
        }

...
public class LrrMmt_MU {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = LrrMmt_MU.class.getClassLoader().getResource("workload/planetlab").getPath();
		String outputFolder = "/home/brian/MonashProgression/FIT3036/output_LrrMmt";
		String workload = "20110403"; // PlanetLab workload
		String vmAllocationPolicy = "lrr_mu"; // Local Regression Robust (LRR) VM allocation policy
